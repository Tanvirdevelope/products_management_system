                                ...
                                <form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            <input id="password" type="password" class="form-control pe-5 password-input" placeholder="Enter password">
                                    ...
                                    <div class="mt-4">
                                        <button onclick="SubmitLogin()" class="btn btn-success w-100" type="submit">Sign In</button>
                                    </div>
