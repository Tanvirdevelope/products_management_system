...
<head>
    ...
    <!-- custom Css-->
    <link href="{{asset('assets/css/custom.min.css')}}a" rel="stylesheet" type="text/css"/>
                ...
                <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                  <div data-simplebar style="max-height: 320px">
                    ...
                    <div class="dropdown-item bg-transparent text-wrap">
                      <a href="index.html" class="btn btn-soft-secondary btn-sm rounded-pill">how to setup <i class="mdimdi-magnify ms-1"></i></a>
                  ...
                  <div class="text-center pt-3 pb-1">
                    <a href="pages-search-results.html"
                      ...
                      >View All Results <i class="ri-arrow-right-line ms-1"></i></a>
                  </div>
                </div>
              </form>
            </div>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="dropdown ms-sm-3 header-item topbar-user">
                <button
                  ...
                  <span class="d-flex align-items-center">
                    ...
                    <span class="text-start ms-xl-2">
                      <span
                        class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Anna Adame</span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  ...
                  <a class="dropdown-item" href="{{url('/userProfile')}}"><i
